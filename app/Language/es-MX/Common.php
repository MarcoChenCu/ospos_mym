...
return [
    ...
    "email_invalid_format"           => "La dirección de correo no tiene el formato correcto.",
    "export_csv"                     => "Exportar a CSV",
    "export_csv_no"                  => "No",
    "export_csv_yes"                 => "Si",
    "fields_required_message"        => "Los campos en rojo son requeridos",
    "fields_required_message_unique" => "Los campos en rojo son requeridos y deben ser únicos",
    "first_name"                     => "Nombre",
    ...
    "learn_about_project"            => "Aprende más sobre el proyecto.",
    "list_of"                        => "Lista de",
    "logo"                           => "Logo",
    "logo_mark"                      => "Marca",
    ...
    "phone_number_required"          => "El número de teléfono es un campo requerido.",
