...
return [
    ...
    "expenses"                                => "Gastos",
    "expenses_amount"                         => "Monto de Gastos",
    ...
    "expenses_payment_amount"                 => "Gasto por Método de Pago",
    "expenses_tax_amount"                     => "Impuesto de Gastos",
    ...
    "low_inventory"                           => "Existencias bajas",
    "low_inventory_report"                    => "Reporte de existencias bajas",
    "low_sell_quantity"                       => "Cantidad de baja venta",
    ...
    "sales_summary_report"                    => "Reporte Resumido de ventas",
    ...
    "sold_to"                                 => "Vendido a",
    "stock_location"                          => "Ubicación de existencia",
